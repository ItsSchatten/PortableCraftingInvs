...
public class Settings extends SimpleConfig {
    ...
    private void onLoad() {
        ...
        USE_STONECUTTER = (boolean) get("use-stonecutter");
        ...
        USE_STONECUTTER_SOUNDS = (boolean) get("use-stonecutter-sounds");
        ...
        STONECUTTER_OPEN_SOUND = getString("stonecutter-open-sound");
