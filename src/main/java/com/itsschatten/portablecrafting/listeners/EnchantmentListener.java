...
public class EnchantmentListener implements Listener {
    ...
    public void prepareEnchantments(PrepareItemEnchantEvent event) {
        ...
        if (FakeContainers.FakeEnchant.getOpenEnchantTables().containsKey(event.getEnchanter().getUniqueId())) {
            int maxLevel = FakeContainers.FakeEnchant.getOpenEnchantTables().get(event.getEnchanter().getUniqueId()).maxLevel;
    ...
    public void closeEnchantInventory(InventoryCloseEvent event) {
        ...
        if (event.getInventory().getType() == InventoryType.ENCHANTING) {
            FakeContainers.FakeEnchant.getOpenEnchantTables().remove(event.getPlayer().getUniqueId());
        }
